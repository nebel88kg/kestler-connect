...
export const metaAdsHub: LandingPage = {
  ...
  problem: {
    ...
    points: [
      ...
      "Kein Tracking oder unklare Lead-Qualität",
      "Organisches Profil wirkt unprofessionell neben Ads",
      "Budget verbrannt ohne klare Lernphase",
    ],
  },
  solution: {
  ...
  benefits: [
    ...
    },
    {
      ...
      description: "Anzeigen, die zum organischen Auftritt passen.",
      icon: "social",
    },
    {
      title: "Lead-Fokus",
      description: "Formulare und Angebote, die echte Anfragen erzeugen.",
      icon: "users",
    },
    {
      title: "Schnelle Tests",
      description: "Formate und Botschaften iterativ verbessern.",
      icon: "rocket",
    },
    {
      title: "Messbarkeit",
      description: "Kosten pro Lead und Kampagnenleistung im Blick.",
      icon: "chart",
    },
    {
      title: "Aus einer Hand",
      description: "Ads und Social Media Betreuung ohne Medienbruch.",
      icon: "check",
    },
  ],
  results: {
    ...
    points: [
      ...
      "Mehr Anfragen aus Facebook & Instagram",
      "Bessere Creatives und Botschaften",
      "Klarere Kosten pro Lead",
      "Stärkerer Gesamteindruck mit organischem Profil",
    ],
  },
  process: [
    { step: 1, title: "Kick-off", description: "Ziel, Angebot und Zielgruppe klären." },
    { step: 2, title: "Setup", description: "Pixel, Kampagnen und Tracking." },
    { step: 3, title: "Creatives", description: "Anzeigen und Varianten produzieren." },
