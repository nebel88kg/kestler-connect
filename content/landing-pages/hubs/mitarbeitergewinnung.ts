...
export const mitarbeitergewinnungHub: LandingPage = {
  ...
  problem: {
    ...
    points: [
      "Zu wenige oder unpassende Bewerbungen",
      "Stellenanzeigen ohne Reichweite",
      "Schwaches oder unglaubwürdiges Arbeitgeber-Profil",
      "Keine klaren Benefits und Bewerbungswege",
      "Hoher Zeitaufwand ohne System",
    ],
  },
  solution: {
  ...
  benefits: [
    {
      title: "Regionale Reichweite",
      description: "Bewerber in Ihrem Einzugsgebiet gezielt ansprechen.",
      icon: "map",
    },
    {
    ...
    {
      title: "Messbarkeit",
      description: "Bewerbungen und Kosten nachvollziehbar steuern.",
      icon: "chart",
    },
  ],
  results: {
    ...
    paragraphs: [
      "Ziel sind mehr passende Bewerbungen und ein professionellerer Arbeitgeber-Eindruck – abhängig von Region, Stelle und Angebot.",
      "Ein glaubwürdiger Online-Auftritt hilft immer: wie bei [SecPro Bildungszentrum](/referenzen/secpro-bildungszentrum), [Golfclub Raffelberg](/referenzen/golfclub-raffelberg) und [DnM](/referenzen/dnm) – starke Präsenz als Grundlage für Kampagnen.",
    ],
    points: [
      "Mehr Sichtbarkeit als Arbeitgeber",
      "Gezieltere Ansprache potenzieller Bewerber",
      "Klarere Stellen- und Benefit-Kommunikation",
      "Schnellere Kampagnenstarts",
      "Nachvollziehbare Bewerbungseingänge",
    ],
  },
  process: [
    { step: 1, title: "Briefing", description: "Stelle, Zielgruppe und Benefits klären." },
    { step: 2, title: "Kreativ", description: "Anzeigen, Texte und Landingpage." },
    { step: 3, title: "Launch", description: "Kampagnen regional ausspielen." },
  ...
  references: [
    {
      ...
      excerpt: "Professioneller Social-Auftritt und Meta Ads – Basis auch für Arbeitgeberwirkung.",
    },
    {
      title: "Golfclub Raffelberg",
      slug: "golfclub-raffelberg",
      excerpt: "Klarer digitaler Auftritt und zielgerichtete Ads.",
    },
    {
      title: "DnM",
      slug: "dnm",
      excerpt: "Sichtbarkeit und Social Media als digitale Grundlage.",
    },
  ],
  faq: [
    {
